...
------------
Aggregates:
1. aggregate name transposes '-'s to '_'s based on cluster base name
2. added is_mirrored parameter to support syncmirror aggregates

Extended standard configuration support:
1. Autosupport - Added standard autosupport configuration to the role
2. Service Processors - Added network configuration support for the SPs
